  ...
  >
    <div className="group rounded px-8 py-12 shadow hover:bg-primary">
      <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div className="hidden group-hover:block">
          <Image
            src="/assets/Image/icon-development-white.svg"
        ...
        <div className="block group-hover:hidden">
          <Image
            src="/assets/Image/icon-development-black.svg"
            alt="development icon"
          />
        </div>
      </div>
    ...
    <div className="group rounded px-8 py-12 shadow hover:bg-primary">
      <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div className="hidden group-hover:block">
          <Image
            src="/assets/Image/icon-content-white.svg"
            alt="content marketing icon"
          />
        </div>
        <div className="block group-hover:hidden">
          <Image
            src="/assets/Image/icon-content-black.svg"
            alt="content marketing icon"
          />
        </div>
      </div>
    ...
    <div className="group rounded px-8 py-12 shadow hover:bg-primary">
      <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div className="hidden group-hover:block">
          <Image
            src="/assets/Image/icon-mobile-white.svg"
            alt="Mobile Application icon"
          />
        </div>
        <div className="block group-hover:hidden">
          <Image
            src="/assets/Image/icon-mobile-black.svg"
            alt="Mobile Application icon"
          />
        </div>
      </div>
    ...
    <div className="group rounded px-8 py-12 shadow hover:bg-primary">
      <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div className="hidden group-hover:block">
          <Image
            src="/assets/Image/icon-email-white.svg"
            alt="Email Marketing icon"
          />
        </div>
        <div className="block group-hover:hidden">
          <Image
            src="/assets/Image/icon-email-black.svg"
            alt="Email Marketing icon"
          />
        </div>
      </div>
    ...
    <div className="group rounded px-8 py-12 shadow hover:bg-primary">
      <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div className="hidden group-hover:block">
          <Image
            src="/assets/Image/icon-design-white.svg"
            alt="Theme Design icon"
          />
        </div>
        <div className="block group-hover:hidden">
          <Image
            src="/assets/Image/icon-design-black.svg"
            alt="Theme Design icon"
          />
        </div>
      </div>
    ...
    <div className="group rounded px-8 py-12 shadow hover:bg-primary">
      <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
        <div className="hidden group-hover:block">
          <Image
            src="/assets/Image/icon-graphics-white.svg"
            alt="Graphic Design icon"
          />
        </div>
        <div className="block group-hover:hidden">
          <Image
            src="/assets/Image/icon-graphics-black.svg"
            alt="Graphic Design icon"
          />
        </div>
      </div>
...
const Portfolio = () => {
  ...
  >
    ...
    >
      <Image
        src="/assets/Image/portfolio-apple.jpeg"
    ...
    >
      <Image
        src="/assets/Image/portfolio-stripe.jpeg"
        className="w-full shadow"
        alt="portfolio image"
      />
    </a>
    ...
    >
      <Image
        src="/assets/Image/portfolio-fedex.jpeg"
        className="w-full shadow"
        alt="portfolio image"
      />
    </a>
    ...
    >
      <Image
        src="/assets/Image/portfolio-microsoft.jpeg"
        className="w-full shadow"
        alt="portfolio image"
      />
    </a>
      ...
      <div className="mx-auto w-full sm:w-3/4 lg:w-full">
        ...
        <div className="flex flex-wrap items-center justify-center pt-4 sm:pt-4">
          <span className="m-8 block">
            <Image
              src="/assets/Image/logo-coca-cola.svg"
              alt="client logo"
          ...
          <span className="m-8 block">
            <Image
              src="/assets/Image/logo-apple.svg"
              alt="client logo"
              className="mx-auto block h-12 w-auto"
            />
          </span>
          ...
          <span className="m-8 block">
            <Image
              src="/assets/Image/logo-netflix.svg"
              alt="client logo"
              className="mx-auto block h-12 w-auto"
            />
          </span>
          ...
          <span className="m-8 block">
            <Image
              src="/assets/Image/logo-amazon.svg"
              alt="client logo"
              className="mx-auto block h-12 w-auto"
            />
          </span>
          ...
          <span className="m-8 block">
            <Image
              src="/assets/Image/logo-stripe.svg"
              alt="client logo"
              className="mx-auto block h-12 w-auto"
            />
          </span>
      ...
      <div className="md:w-2/5">
        <div className="flex justify-center md:justify-start">
          <span className="shrink-0">
            <Image
              src="/assets/Image/logo-spotify.svg"
    ...
    <div className="mt-8 flex flex-col text-center md:flex-row md:text-left">
      <div className="md:w-2/5">
        <div className="flex justify-center md:justify-start">
          <span className="shrink-0">
            <Image
              src="/assets/Image/logo-microsoft.svg"
              className="h-auto w-32"
              alt="company logo"
            />
          </span>
    ...
    <div className="mt-8 flex flex-col text-center md:flex-row md:text-left">
      <div className="md:w-2/5">
        <div className="flex justify-center md:justify-start">
          <span className="shrink-0">
            <Image
              src="/assets/Image/logo-fedex.svg"
              className="h-auto w-32"
              alt="company logo"
            />
          </span>
...
const Statistics = () => {
  return (
    ...
    style={{ backgroundImage: 'url(/assets/Image/experience-figure.png)' }}
    id="statistics">
  </div>
    ...
    >
      <div className="grid grid-cols-2 gap-5 md:gap-8 xl:grid-cols-4 xl:gap-5">
        ...
        >
          <div>
            <Image
              src="/assets/Image/icon-project.svg"
        ...
        >
          <div>
            <Image
              src="/assets/Image/icon-award.svg"
              className="mx-auto h-12 w-auto md:h-20"
              alt="icon award"
            />
          </div>
        ...
        >
          <div>
            <Image
              src="/assets/Image/icon-happy.svg"
              className="mx-auto h-12 w-auto md:h-20"
        ...
        >
          <div>
            <Image
              src="/assets/Image/icon-puzzle.svg"
              className="mx-auto h-12 w-auto md:h-20"
              alt="icon puzzle"
            />
          </div>
  ...
  <div className="container py-16 md:py-20">
    ...
    >
      <a href="/post" className="shadow">
        <div
          style={{backgroundImage: "url(/assets/Image/post-01.png)"}}
      ...
      <a href="/post" className="shadow">
        <div
          style={{backgroundImage: "url(/assets/Image/post-02.png)"}}
          className="group relative h-72 bg-cover bg-center bg-no-repeat sm:h-84 lg:h-64 xl:h-72"
        >
          <span
            className="absolute inset-0 block bg-gradient-to-b from-blog-gradient-from to-blog-gradient-to bg-cover bg-center bg-no-repeat opacity-10 transition-opacity group-hover:opacity-50"
      ...
      <a href="/post" className="shadow">
        <div
          style={{ backgroundImage: 'url(/assets/Image/post-03.png)' }}
          className="group relative h-72 bg-cover bg-center bg-no-repeat sm:h-84 lg:h-64 xl:h-72"
        >
          <span
            className="absolute inset-0 block bg-gradient-to-b from-blog-gradient-from to-blog-gradient-to bg-cover bg-center bg-no-repeat opacity-10 transition-opacity group-hover:opacity-50"
  ...
  return (
    <>
      <div className="container py-16 md:py-20" id="contact">
        ...
        <div className="mx-auto w-full pt-5 text-center sm:w-2/3 lg:pt-6">
          <p className="font-body text-grey-10">
            Lorem ipsum dolor sit amet consectetur adipiscing elit hendrerit condimentum turpis nisl sem, viverra habitasse urna ante
            lobortis fermentum accumsan. Viverra habitasse urna ante lobortis fermentum accumsan.
          </p>
        </div>
        <form className="mx-auto w-full pt-10 sm:w-3/4">
          ...
          <textarea
            className="mt-6 w-full rounded border-gray-50 px-4 py-3 font-body text-black md:mt-8"
            placeholder="Message"
            id="message"
            cols={30}
            rows={10}
        ...
        <div className="flex flex-col pt-16 lg:flex-row">
          <div className="w-full border-l-2 border-t-2 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3">
            ...
            <p className="pt-2 text-left font-body font-bold text-primary lg:text-lg">(+881) 111 222 333</p>
          </div>
          <div className="w-full border-l-2 border-t-0 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3 lg:border-l-0 lg:border-t-2">
            ...
            <p className="pt-2 text-left font-body font-bold text-primary lg:text-lg">name@mydomain.com</p>
          </div>
          <div className="w-full border-l-2 border-t-0 border-r-2 border-b-2 border-grey-60 px-6 py-6 sm:py-8 lg:w-1/3 lg:border-l-0 lg:border-t-2">
            <div className="flex items-center">
      ...
      <div
        ...
        style={{ backgroundImage: "url(/assets/Image/map.png)" }}
      ></div>
      <div
        className="relative bg-primary bg-cover bg-center bg-no-repeat py-16 bg-blend-multiply lg:py-24"
        style={{ backgroundImage: "url(/assets/Image/bg-cta.jpg)" }}
      >
